...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("clear", "Delete recent bot replies and start a clean session", "Session",
               aliases=("clean",), args_hint="[count]",
               busy_policy="interrupt_then_dispatch", busy_handler="clear"),
    ...
    CommandDef("account", "List or switch provider accounts on this gateway", "Info",
               gateway_only=True, args_hint="[list | use <openai|claude> <account-id>]",
               subcommands=("list", "status", "use", "switch")),
