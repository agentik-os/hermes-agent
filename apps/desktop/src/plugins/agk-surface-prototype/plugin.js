  ...
  build: {
    ...
    primary: [
      ...
      },
      {
        ...
        body: 'Current AGK OS surface. Governed execution remains explicit.',
    ...
    context: [
      ...
      ['Environment', 'Local macOS AGK OS']
    ]
  },
  deals: {
    id: 'deals',
    ...
    primary: [
      {
        ...
        meta: '3 commitments',
        body: 'Review the five-universe command center, choose the next implementation boundary and protect deep-work time.',
        action: 'Open today'
      },
      {
        title: 'Decision journal',
        meta: 'Private by default',
        body: 'The AGK OS decision is scoped and cannot grant Build authority.',
  ...
  return jsxs('article', {
    ...
    children: [
      ...
      jsx('button', {
        ...
        onClick: () => host.notify({ kind: 'info', message: `${item.action} is not wired yet in AGK OS.` }),
  ...
  return jsxs('aside', {
    ...
    children: [
      ...
      jsxs('div', {
        ...
        children: [
          jsx(Badge, { variant: 'warn', size: 'xs', children: 'AGK OS' }),
          jsx('p', { children: 'Domain state and governed Runtime connections remain explicit.' })
        ]
      })
    ]
  })
                ...
                children: [
                  ...
                  jsxs('div', {
                    children: [
                      ...
                      jsx('span', { children: 'Personal Intelligence System' })
                    ]
                  })
                ]
              }),
                ...
                children: spec.nav.map((item, index) =>
                  jsx(
                    'button',
                    {
                      ...
                      onClick: () => host.notify({ kind: 'info', message: `${item} is not wired yet in AGK OS.` }),
                      children: item
                    },
                    item
                  )
...
export default {
  id: ID,
  name: 'AGK Surface',
  description: 'Ratified Collective, Learn, Build, Deals and Evolve shell for AGK Desktop.',
  required: true,
  register(ctx) {
    installStyles(ctx)
    ctx.registerMany([
      ...
      },
      {
        ...
        order: 5,
        data: { codicon: 'project', label: 'AGK OS', path: ROUTE }
      },
      {
        id: 'open',
        area: PALETTE_AREA,
        data: {
          ...
          label: 'AGK OS: Open surface shell',
          keywords: ['agk', 'collective', 'learn', 'build', 'deals', 'evolve', 'os'],
